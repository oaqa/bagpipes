...
package uima.components.examples.ex2;
 ...
 * using the {@link JCasAnnotator_ImplBase uimaFIT's JCasAnnotator_ImplBase}
 * class obviates the need for an initialize method at all because the super
 * class initialize method calls
 * {@link ConfigurationParameterInitializer#initializeConfigurationParameters}.
 * This method initializes member variables annotated as configuration
 * parameters using the configuration parameter information provided in the
 * UimaContext.
 * 
	...
	public void process(JCas aJCas) throws AnalysisEngineProcessException {
		...
		for (int i = 0; i < mPatterns.length; i++) {
			...
			while (matcher.find()) {
				...
				RoomNumber annotation = new RoomNumber(aJCas, matcher.start(),
						matcher.end());
